...
#' @param npulls.per.period  A positive integer  or a vector of positive integers.
#' Default value is 1. If \code{npulls.per.period} is a positive integer,
#' the number of pulls is \code{npulls.per.period} for each period.
